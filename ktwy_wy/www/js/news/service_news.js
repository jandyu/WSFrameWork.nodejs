    ...
    var news_wy=angular.extend({},IService,{
      ...
      getlist_after:function()
      {
        ...
        $.each(me.model_list, function (k,val) {
          ...
          val.imagelist_url_real= _.filter(val.imagelist_url,function(itm){return itm.rid!="";});
        });
      ...
      getmodel_after:function() {
        ...
        me.model.imagelist_url_real= _.filter(me.model.imagelist_url,function(itm){return itm.rid!="";});
