...
<body>   
    <div class="container-fluid ls-page-base ls-page-module">
        <div class="row nolast">
            <div class="col-xs-3">
                <img src="../v1/imgs/1业主查询.png" /></br>
                <label>业主查询</label>                
            </div>
            <div class="col-xs-3">
                <img src="../v1/imgs/2车牌查询.png" /></br>
                <label>业主查询</label>   
            </div>
            <div class="col-xs-3">
                <img src="../v1/imgs/3投诉表扬.png" /></br>
                <label>业主查询</label>   
            </div>
            <div class="col-xs-3">
                <img src="../v1/imgs/4维修.png" /></br>
                <label>业主查询</label>   
            </div>
        </div>
        ...
        <div class="row nolast">
            <div class="col-xs-3">
                <img src="../v1/imgs/5社区通知.png" /></br>
                <label>社区通知</label>                
            </div>
            <div class="col-xs-3">
                <img src="../v1/imgs/6物业费查询.png" /></br>
                <label>物业费查询</label>   
            </div>
            <div class="col-xs-3">
                <img src="../v1/imgs/7短信群发.png" /></br>
                <label>短信群发</label>   
            </div>
            <div class="col-xs-3">
                <img src="../v1/imgs/8快递录入.png" /></br>
                <label>快递录入</label>   
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-3">
                <img src="../v1/imgs/9水费抄表.png" /></br>
                <label>水费抄表</label>                
            </div>
            <div class="col-xs-3">
                <img src="../v1/imgs/10访客信息.png" /></br>
                <label>访客信息</label>   
            </div>
            <div class="col-xs-3">
                <img src="../v1/imgs/11保安巡逻.png" /></br>
                <label>保安巡逻</label>   
            </div>
            <div class="col-xs-3">
                <img src="../v1/imgs/12消息推送.png" /></br>
                <label>消息推送</label>   
            </div>
        </div>
    </div> 
    ...
    <div class="container-fluid ls-page-base ls-page-notify">
        <div class="row title">
            ...
            <div class="col-xs-5 detail">显示全部<img src="../v1/imgs/arr_right.png" /></div>
        </div>
