...
//	private float xDown;
//	// x方向滑动锁定
//	private boolean xMoveLock = false;
//	/**
...
//			this.webView = (WebBrowser) getChildAt(1);
//			this.webView.setOnTouchListener(this);
//			loadOnce = true;
//		}
//	}
//	
//	private boolean canRefresh = false;// 刷新
//	private boolean canPageDown = false;// 下一页
//	
//
...
//				
//				
//				if (this.webView.getScrollY() == 0)// 滚到顶
//					canRefresh = true;
//				else
//					canRefresh = false;
//				
//				if (this.webView.getContentHeight() * this.webView.getScaleY() - this.webView.getHeight() - this.webView.getScrollY() <= 0)// 滚到底
//					canPageDown = true;
//				else
//					canPageDown = false;
//				break;
...
//					if (distanceY <= 0 && headerLayoutParams.topMargin <= hideHeaderHeight)
//					{
//						return false;
//					}
...
//						headerLayoutParams.topMargin = (distanceY / 2) + hideHeaderHeight;
