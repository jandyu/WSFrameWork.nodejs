...
::copy config files
copy build\BuildConfig\build_lovegreen.xml build.xml   /y


::update versionCode and versionName
build\Other\AndroidBuildHelper.jar -fAndroidManifestFiles\AndroidManifest_LoveGreen.xml

copy AndroidManifestFiles\AndroidManifest_LoveGreen.xml AndroidManifest.xml /y
